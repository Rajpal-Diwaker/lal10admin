...
export class GetListComponent implements OnInit {
  ...
  listHeaders: any = ['Image', 'Category Name', 'Total Sub-category', 'Total Products', 'Created on',
    'Best Seller', 'Action', 'Status'];
  listArr: any = [];
  listArrbackup: any = [];
  ...
  edit(id) {
    ...
    this.router.navigate(['/managecategory/edit'], { queryParams: { id: JSON.stringify(id) } });
  }
